...
const authLoginController = async (ctx, next) => {
  let result;
  try {
...
const authVerifyController = async (ctx, next) => {
  let result;
  try {
...
module.exports = { authLoginController, authVerifyController };